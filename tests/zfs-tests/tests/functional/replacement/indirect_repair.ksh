...
#	6. Reverse the replacement, corrupt the DTL-clean source segment, and
#	   recover from the DTL-dirty target through an ordinary cold read,
#	   which must also repair the source before the scan resumes.
